const crops=document.getElementById("crops-inputbox");
...
console.log("Maximum temperature",tempMax);
console.log("Minimum temperature",tempMin);
console.log("Precipitation",precipitation);

resultdiv.textContent=`Max Temp: ${tempMax} °C, Min Temp: ${tempMin} °C, Precipitation: ${precipitation} mm`;
